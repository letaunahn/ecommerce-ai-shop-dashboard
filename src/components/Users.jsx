    ...
    <>
      <main className="p-[10px] pl-[10px] md:pl-[17rem] w-full">
        <div className="flex-1 md:p-6">
          ...
          <div className="p-4 sm:p-8 bg-gray-50 max-h-screen">
            <div
            ...
            {!loading && users.length > 0 && (
              <div className="flex justify-center mt-6 gap-4">
                <button
                  ...
                  disabled={page === 1}
                  className="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded cursor-pointer disabled:opacity-50">
                  Previous
                </button>
                <span className="px-4 py-2 text-gray-700">Page {page}</span>
                <button onClick={() => setPage((prev) => prev + 1)}
                  disabled={maxPage === page}
                  className="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded cursor-pointer disabled:opacity-50">Next</button>
              </div>
            )}
          </div>
        </div>

  ...
  const summary = [
    {
      ...
      subText: `This month's sales: USD ${currentMonthSales}`,
    ...
    },
    {
      ...
      subText: topSellingProducts?.length
    ...
    {
      text: "New Customer This Month",
      subText: `New customer joined: ${newUsersThisMonth}`,
